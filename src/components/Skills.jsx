...
export const Skills = () => {
  ...
  return (
    <>
      ...
      <section className="flex flex-col items-center justify-center w-full px-4 font-body">
        <div className="w-full max-w-4xl p-6 sm:p-10">
          {/* Tabs */}
          <ul className="flex justify-center gap-4 sm:gap-6 border-b border-gray-300 pb-2">
            {tabs.map((tab) => (
              <motion.li
                key={tab.label}
          ...
          <AnimatePresence mode="wait">
            <motion.ul
              ...
              className="grid grid-cols-[repeat(auto-fit,minmax(120px,max-content))] justify-center gap-4 mt-6"
            >
